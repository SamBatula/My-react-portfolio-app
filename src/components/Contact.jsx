  ...
  return (
    <div name='contact' className='w-full h-screen bg-[#023020] flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/1895b10c-0208-4eb5-a9d3-2e2e7a1a9588" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                <p className='text-4xl font-bold inline border-b-4 border-[#d9b99b] text-[#ccd6f6]'>Contact</p>
                <p className='text-[#ccd6f6] py-4'> Feel free to reach out if you have any questions! My Email: Samsonbatula@gmail.com </p>
            </div>
